  ...
  return (
    <UserInfo>
      ...
      <RowInfo>
        ...
        <div class="info">
          <h3>CONTACT</h3>
          {allowChanges ? <input value={user?.phoneNo} name="phoneNo" onChange={setProps} /> : <span>{`${user?.phoneNo}`}</span>}
        </div>
      </RowInfo>
      ...
      <RowInfo>
        <div class="info">
          <h3>DATE OF BIRTH</h3>
          {allowChanges ? <input type="date" value={user?.birthdate} name="birthdate" onChange={setProps} /> : <span>{`${user?.birthdate}`}</span>}
        </div>
